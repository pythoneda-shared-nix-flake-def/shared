...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-git-shared = {
      ...
      url = "github:pythoneda-shared-git-def/shared/0.0.36";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "shared";
        version = "0.0.16";
        sha256 = "00l0kxiq49nwrzkvksc7ddxfhw87gmllv9wkmzxfdmsf5xbl4jbh";
        pname = "${org}-${repo}";
        ...
        pythoneda-shared-nix-flake-shared-for = { python
          , pythoneda-shared-git-shared, pythoneda-shared-domain
          , stringtemplate3 }:
          let
